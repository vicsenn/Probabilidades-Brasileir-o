...
prob_02 <- list(c(tab[tab[,1] == 'GRE',4]/tab[tab[,1] == 'GRE',3], tab[tab[,1] == 'FLA',4]/tab[tab[,1] == 'FLA',3], (tab[tab[,1] == 'GRE',5] + tab[tab[,1] == 'FLA',5])/(tab[tab[,1] == 'GRE',3] + tab[tab[,1] == 'FLA',3])))

prob_30 <- list(c(tab[tab[,1] == 'ACG',4]/tab[tab[,1] == 'ACG',3], tab[tab[,1] == 'JUV',4]/tab[tab[,1] == 'JUV',3], (tab[tab[,1] == 'ACG',5] + tab[tab[,1] == 'JUV',5])/(tab[tab[,1] == 'ACG',3] + tab[tab[,1] == 'JUV',3])))
...
prob_34 <- list(c(tab[tab[,1] == 'SAO',4]/tab[tab[,1] == 'SAO',3], tab[tab[,1] == 'CAP',4]/tab[tab[,1] == 'CAP',3], (tab[tab[,1] == 'SAO',5] + tab[tab[,1] == 'CAP',5])/(tab[tab[,1] == 'SAO',3] + tab[tab[,1] == 'CAP',3])))

prob_35 <- list(
c(tab[tab[,1] == 'PAL',4]/tab[tab[,1] == 'PAL',3], tab[tab[,1] == 'CAP',4]/tab[tab[,1] == 'CAP',3], (tab[tab[,1] == 'PAL',5] + tab[tab[,1] == 'CAP',5])/(tab[tab[,1] == 'PAL',3] + tab[tab[,1] == 'CAP',3])),
c(tab[tab[,1] == 'FLU',4]/tab[tab[,1] == 'FLU',3], tab[tab[,1] == 'INT',4]/tab[tab[,1] == 'INT',3], (tab[tab[,1] == 'FLU',5] + tab[tab[,1] == 'INT',5])/(tab[tab[,1] == 'FLU',3] + tab[tab[,1] == 'INT',3])),
c(tab[tab[,1] == 'SAN',4]/tab[tab[,1] == 'SAN',3], tab[tab[,1] == 'FOR',4]/tab[tab[,1] == 'FOR',3], (tab[tab[,1] == 'SAN',5] + tab[tab[,1] == 'FOR',5])/(tab[tab[,1] == 'SAN',3] + tab[tab[,1] == 'FOR',3])),
c(tab[tab[,1] == 'CEA',4]/tab[tab[,1] == 'CEA',3], tab[tab[,1] == 'COR',4]/tab[tab[,1] == 'COR',3], (tab[tab[,1] == 'CEA',5] + tab[tab[,1] == 'COR',5])/(tab[tab[,1] == 'CEA',3] + tab[tab[,1] == 'COR',3])),
